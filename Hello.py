...
# Расчет затрат на ремонт и общей стоимости
...
col1.metric("💰 Цена входа:", f'{selected_flat["bargainTerms.price"]} руб.')
col2.metric("💸 Цена выхода:", f'{expected_sale_price * selected_flat["area"]} руб.')
col3.metric("💸 Прибыль:", f'{profit} руб.')

# Отображение характеристик квартиры
...
with tab2:
    ...
    st.dataframe(competitors_data[['city', 'street', 'address', 'rooms', 'area', 'kitchen_area', 'renovation',
                                   'floor', 'house_floors', 'house_wall_type', 'build_year', 'time_on_foot_to_subway',
                                   'Distance (meters)', 'price_sq', 'bargainTerms.price', 'Price Difference', 'Selected']]
